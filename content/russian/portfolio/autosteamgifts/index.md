...
Проект изначально создавался на продажу — как готовое self-hosted решение «под ключ» для запуска собственного магазина Steam-подарков. Скоро он появится в продаже.
...
Проект готовится к продаже и скоро будет доступен для приобретения.
