	...
	function appendStyles () {
	  ...
	  const styles = /*css*/`
		#${id} {
		  ...
		  border-radius: 50%; /* Вместо круглой формы делаем слегка закругленную */
		...
		@media (max-width: 768px) {
		  #${id} {
			width: 93%; /* Растягиваем на 80% ширины экрана */
			height: 48px; /* Устанавливаем фиксированную высоту */
			bottom: ${cornerOffset * 2}px; /* Увеличиваем отступ снизу */
			left: 50%; /* Центрируем кнопку */
			transform: translateX(-50%); /* Смещаем на половину ширины, чтобы оказаться в центре */
			right: auto; /* Убираем отступ справа */
			border-radius: 8px;
		  }
		  #${id} svg {
			height: 24px; /* Фиксированный размер иконки */
			width: 24px;
			margin: 12px auto 0; /* Центрируем иконку внутри кнопки */
		  }
		}
	  `;
